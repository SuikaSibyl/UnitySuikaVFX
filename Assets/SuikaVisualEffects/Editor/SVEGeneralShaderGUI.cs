...
internal class SVEGeneralShaderGUI : ShaderGUI
{
    ...
    MaterialProperty grabMode = null;
    ...
    MaterialProperty uvaXSpeed = null;
    MaterialProperty uvaYSpeed = null;
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        grabMode     = FindProperty("_GrabMode", props);
        ...
        uvaXSpeed = FindProperty("_SpeedX", props);
        uvaYSpeed = FindProperty("_SpeedY", props);
